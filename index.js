...
let steak=createMenuItem('steak',16,'dinner')

console.log(steak)

let pasta=createMenuItem('pasta',12,'dinner')
...
*/
 ...
 function getReviewByRating(array,range) {
  const reviewArray=[];  
  for(let i = 0;i < array.length; i++){
    if(array[i].rating >= range && array[i].rating < range + 1){
